#!/usr/bin/env python3
"""Evaluate a trained Go2 rear-stand skill policy."""
...
parser = argparse.ArgumentParser(description="Evaluate Go2 rear-stand skill policy")
...
def main():
    ...
    env = Go2RearStandEnv(num_envs=1, headless=False)
