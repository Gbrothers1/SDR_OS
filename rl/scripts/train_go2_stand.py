...
parser = argparse.ArgumentParser(description="Train Go2 stand skill policy")
...
def main():
    ...
    env = Go2StandEnv(num_envs=args.num_envs, headless=True)
    env = VideoWrapper(
        env,
        video_length_sec=8,
