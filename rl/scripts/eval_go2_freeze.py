#!/usr/bin/env python3
"""Evaluate a trained Go2 freeze skill policy."""
...
EXPERIMENT_NAME = "go2-freeze"

parser = argparse.ArgumentParser(description="Evaluate Go2 freeze skill policy")
...
def main():
    ...
    from rl.envs.go2_skill_env import Go2FreezeEnv
    ...
    env = Go2FreezeEnv(num_envs=1, headless=False)
