#!/usr/bin/env python3
"""Train Go2 gamepad-conditioned locomotion policy."""
...
parser = argparse.ArgumentParser(description="Train Go2 gamepad locomotion policy")
...
def training_cfg(exp_name: str, max_iterations: int, num_envs: int):
    return {
        ...
        "env": {
            "env_name": "go2_gamepad_locomotion",
        },
    }
